...
class DataFormatConverter:
    ...
    def _add_key(self, key: str, value: int):
        """
    ...
    def _split(self):
        ...
        for subset in subsets:
            ...
            self._logger.info(f"Storing {subset} json at {Path(self._output_dir, output_name)}.")
...
def correct_faulty_panoramas():
    ...
    data_root = "/Users/dianaepureanu/Documents/data"
    input = "/Users/dianaepureanu/Documents/Projects/containers-annotated-1151.json"
    resized_input = "/Users/dianaepureanu/Documents/Projects/containers-annotated-1151-4000x2000.json"
    output_dir = "/Users/dianaepureanu/Documents/resized_resolution"
    subsets = ["train", "val", "test"]
    ...
    def _move(_input):
        """
        Find images of resolution 2000x1000 and move them to a different directory
        """
    ...
    def _is_moved():
        """
        Check whether 2000x1000 files are already moved in separate folders
        """
        moved = True
        for subset in subsets:
            ...
            if elements_count == 0:
                print(f"Moving images to {subset}")
                moved = False
        return moved

    def _upscale(image_path):
        """
        Upscale one image
        """
    ...
    _create_dirs()
    if _is_moved() is False:
        print(f"Moving images to {output_dir}/$subset_2000x1000...")
        _move(_input)
    else:
        print(f"Images were already moved to {output_dir}/$subset_2000x1000...")

    if _is_upscaled() is False:
        print(f"Upscaling images and storing them at {output_dir}/$subset_4000x2000...")
        _upscale_all()
    else:
        print(f"Images were already upscaled and stored at {output_dir}/$subset_4000x2000...")
