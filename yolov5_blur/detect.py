# Cloned this commit https://github.com/ultralytics/yolov5/commit/342fe05e6c88221750ce7e90b7d2e8baabd397dc
...
def parse_opt():
    ...
    parser.add_argument('--source', type=str, default='unblurred', help='file/dir/URL/glob/screen/0(webcam)')
    parser.add_argument('--data', type=str, default='data/pano.yaml', help='(optional) dataset.yaml path')
